  ...
  it("renders input group", () => {
    render(
      <>
        ...
        <InputGroup name="description" text="Description" type="textarea" />
    ...
    let descriptionLabel = screen.getByTestId("description-label");
    ...
    let descriptionTextarea = screen.getByTestId("description-textarea");
